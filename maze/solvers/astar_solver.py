...
class AStarMazeSolver(BaseMazeSolver):
    ...
    def _heuristic(self, a: Tuple[int, int], b: Tuple[int, int]) -> float:
        ...
        Args:
            a (Tuple[int, int]): First point coordinates (x, y).
            b (Tuple[int, int]): Second point coordinates (x, y).
    ...
    def solve_step_by_step(self, start: Tuple[int, int], end: Tuple[int, int]):
        """Solve the maze using A* algorithm, yielding each step for animation.
